    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
      ...
      <div>
        ...
        <Input
          ...
          placeholder="e.g., Mesin Pencetak Gula"
          className="mt-1"
        />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          <Label>Brand</Label>
          <Input value={brand} onChange={e => setBrand(e.target.value)} placeholder="e.g., ABB" className="mt-1" />
        </div>
        <div>
          <Label>Model</Label>
          <Input value={model} onChange={e => setModel(e.target.value)} placeholder="e.g., VFD-X5" className="mt-1" />
        </div>
        <div>
          <Label>No. Seri</Label>
      ...
      <div>
        ...
        <Select value={status} onValueChange={(v) => setStatus(v ?? '')}>
          ...
          <SelectContent>
            <SelectItem value="running">Beroperasi</SelectItem>
            <SelectItem value="repairing">Perbaikan</SelectItem>
            <SelectItem value="standby">Standby</SelectItem>
            <SelectItem value="scrapped">Dihapus</SelectItem>
          </SelectContent>
        </Select>
      </div>
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Catatan tambahan tentang mesin ini..."
          rows={3}
          className="mt-1"
        />
      </div>
